...
bool
radar_conti_ars408_msgs__msg__FilterStateCfg__init(radar_conti_ars408_msgs__msg__FilterStateCfg * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    radar_conti_ars408_msgs__msg__FilterStateCfg__fini(msg);
    return false;
  }
  // filtercfg_valid
...
void
radar_conti_ars408_msgs__msg__FilterStateCfg__fini(radar_conti_ars408_msgs__msg__FilterStateCfg * msg)
{
  if (!msg) {
    return;
  }
...
bool
radar_conti_ars408_msgs__msg__FilterStateCfg__are_equal(const radar_conti_ars408_msgs__msg__FilterStateCfg * lhs, const radar_conti_ars408_msgs__msg__FilterStateCfg * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
radar_conti_ars408_msgs__msg__FilterStateCfg__copy(
  const radar_conti_ars408_msgs__msg__FilterStateCfg * input,
  radar_conti_ars408_msgs__msg__FilterStateCfg * output)
{
  if (!input || !output) {
    return false;
  }
...
radar_conti_ars408_msgs__msg__FilterStateCfg *
radar_conti_ars408_msgs__msg__FilterStateCfg__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  radar_conti_ars408_msgs__msg__FilterStateCfg * msg = (radar_conti_ars408_msgs__msg__FilterStateCfg *)allocator.allocate(sizeof(radar_conti_ars408_msgs__msg__FilterStateCfg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(radar_conti_ars408_msgs__msg__FilterStateCfg));
  bool success = radar_conti_ars408_msgs__msg__FilterStateCfg__init(msg);
  if (!success) {
...
void
radar_conti_ars408_msgs__msg__FilterStateCfg__destroy(radar_conti_ars408_msgs__msg__FilterStateCfg * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    radar_conti_ars408_msgs__msg__FilterStateCfg__fini(msg);
...
bool
radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence__init(radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  radar_conti_ars408_msgs__msg__FilterStateCfg * data = NULL;

  if (size) {
    data = (radar_conti_ars408_msgs__msg__FilterStateCfg *)allocator.zero_allocate(size, sizeof(radar_conti_ars408_msgs__msg__FilterStateCfg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = radar_conti_ars408_msgs__msg__FilterStateCfg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        radar_conti_ars408_msgs__msg__FilterStateCfg__fini(&data[i - 1]);
      }
...
void
radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence__fini(radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      radar_conti_ars408_msgs__msg__FilterStateCfg__fini(&array->data[i]);
    }
...
radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence *
radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * array = (radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence *)allocator.allocate(sizeof(radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence__init(array, size);
  if (!success) {
...
void
radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence__destroy(radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence__are_equal(const radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * lhs, const radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!radar_conti_ars408_msgs__msg__FilterStateCfg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence__copy(
  const radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * input,
  radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(radar_conti_ars408_msgs__msg__FilterStateCfg);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    radar_conti_ars408_msgs__msg__FilterStateCfg * data =
      (radar_conti_ars408_msgs__msg__FilterStateCfg *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!radar_conti_ars408_msgs__msg__FilterStateCfg__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          radar_conti_ars408_msgs__msg__FilterStateCfg__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!radar_conti_ars408_msgs__msg__FilterStateCfg__copy(
