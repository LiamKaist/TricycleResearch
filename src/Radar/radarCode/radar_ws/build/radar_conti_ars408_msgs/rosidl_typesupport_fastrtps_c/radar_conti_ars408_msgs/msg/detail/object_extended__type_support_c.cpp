...
#include "radar_conti_ars408_msgs/msg/detail/object_extended__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/float64__functions.h"  // obj_arellat, obj_arellong, obj_length, obj_orientationangle, obj_width
...
using _ObjectExtended__ros_msg_type = radar_conti_ars408_msgs__msg__ObjectExtended;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectExtended__ros_msg_type * ros_message = static_cast<const _ObjectExtended__ros_msg_type *>(untyped_ros_message);
  // Field name: obj_arellong
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->obj_arellong, cdr))
    {
      return false;
    }
  }

  // Field name: obj_arellat
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  // Field name: obj_orientationangle
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->obj_orientationangle, cdr))
    {
      return false;
    }
  }

  // Field name: obj_length
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  void * untyped_ros_message)
{
  ...
  _ObjectExtended__ros_msg_type * ros_message = static_cast<_ObjectExtended__ros_msg_type *>(untyped_ros_message);
  // Field name: obj_arellong
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ObjectExtended__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_radar_conti_ars408_msgs__msg__ObjectExtended(
...
static size_t _ObjectExtended__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_radar_conti_ars408_msgs__msg__ObjectExtended(
...
static message_type_support_callbacks_t __callbacks_ObjectExtended = {
...
static rosidl_message_type_support_t _ObjectExtended__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectExtended,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, radar_conti_ars408_msgs, msg, ObjectExtended)() {
  return &_ObjectExtended__type_support;
}
