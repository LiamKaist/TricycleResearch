...
#include "radar_conti_ars408_msgs/msg/detail/filter_state_cfg__rosidl_typesupport_fastrtps_c.h"
...
using _FilterStateCfg__ros_msg_type = radar_conti_ars408_msgs__msg__FilterStateCfg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _FilterStateCfg__ros_msg_type * ros_message = static_cast<const _FilterStateCfg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _FilterStateCfg__ros_msg_type * ros_message = static_cast<_FilterStateCfg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_radar_conti_ars408_msgs__msg__FilterStateCfg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FilterStateCfg__ros_msg_type * ros_message = static_cast<const _FilterStateCfg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _FilterStateCfg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_radar_conti_ars408_msgs__msg__FilterStateCfg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_radar_conti_ars408_msgs
size_t max_serialized_size_radar_conti_ars408_msgs__msg__FilterStateCfg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _FilterStateCfg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_radar_conti_ars408_msgs__msg__FilterStateCfg(
...
static message_type_support_callbacks_t __callbacks_FilterStateCfg = {
...
static rosidl_message_type_support_t _FilterStateCfg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FilterStateCfg,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, radar_conti_ars408_msgs, msg, FilterStateCfg)() {
  return &_FilterStateCfg__type_support;
}
