...
void fetch_function__ObjectList__objects(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const radar_conti_ars408_msgs::msg::Object *>(
    get_const_function__ObjectList__objects(untyped_member, index));
  auto & value = *reinterpret_cast<radar_conti_ars408_msgs::msg::Object *>(untyped_value);
  value = item;
}

void assign_function__ObjectList__objects(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<radar_conti_ars408_msgs::msg::Object *>(
    get_function__ObjectList__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const radar_conti_ars408_msgs::msg::Object *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectList_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__ObjectList__objects,  // fetch(index, &value) function pointer
    assign_function__ObjectList__objects,  // assign(index, value) function pointer
