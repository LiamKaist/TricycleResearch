...
#include "radar_conti_ars408_msgs/msg/detail/filter_state_cfg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const radar_conti_ars408_msgs::msg::FilterStateCfg & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_valid,
    cdr);
  // Member: filtercfg_active
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_active,
    cdr);
  // Member: filtercfg_index
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_index,
    cdr);
  // Member: filtercfg_type
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_type,
    cdr);
  // Member: filtercfg_min_nofobj
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_nofobj,
    cdr);
  // Member: filtercfg_min_distance
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_distance,
    cdr);
  // Member: filtercfg_min_azimuth
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_azimuth,
    cdr);
  // Member: filtercfg_min_vreloncome
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_vreloncome,
    cdr);
  // Member: filtercfg_min_vreldepart
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_vreldepart,
    cdr);
  // Member: filtercfg_min_rcs
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_rcs,
    cdr);
  // Member: filtercfg_min_lifetime
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_lifetime,
    cdr);
  // Member: filtercfg_min_size
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_size,
    cdr);
  // Member: filtercfg_min_probexists
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_probexists,
    cdr);
  // Member: filtercfg_min_y
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_y,
    cdr);
  // Member: filtercfg_min_x
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_x,
    cdr);
  // Member: filtercfg_min_vyrightleft
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_vyrightleft,
    cdr);
  // Member: filtercfg_min_vxoncome
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_vxoncome,
    cdr);
  // Member: filtercfg_min_vyleftright
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_vyleftright,
    cdr);
  // Member: filtercfg_min_vxdepart
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_vxdepart,
    cdr);
  // Member: filtercfg_min_object_class
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_min_object_class,
    cdr);
  // Member: filtercfg_max_nofobj
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_nofobj,
    cdr);
  // Member: filtercfg_max_distance
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_distance,
    cdr);
  // Member: filtercfg_max_azimuth
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_azimuth,
    cdr);
  // Member: filtercfg_max_vreloncome
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_vreloncome,
    cdr);
  // Member: filtercfg_max_vreldepart
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_vreldepart,
    cdr);
  // Member: filtercfg_max_rcs
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_rcs,
    cdr);
  // Member: filtercfg_max_lifetime
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_lifetime,
    cdr);
  // Member: filtercfg_max_size
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_size,
    cdr);
  // Member: filtercfg_max_probexists
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_probexists,
    cdr);
  // Member: filtercfg_max_y
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_y,
    cdr);
  // Member: filtercfg_max_x
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_x,
    cdr);
  // Member: filtercfg_max_vyrightleft
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_vyrightleft,
    cdr);
  // Member: filtercfg_max_vxoncome
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_vxoncome,
    cdr);
  // Member: filtercfg_max_vyleftright
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_vyleftright,
    cdr);
  // Member: filtercfg_max_vxdepart
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_vxdepart,
    cdr);
  // Member: filtercfg_max_object_class
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.filtercfg_max_object_class,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  radar_conti_ars408_msgs::msg::FilterStateCfg & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_radar_conti_ars408_msgs
max_serialized_size_FilterStateCfg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static bool _FilterStateCfg__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const radar_conti_ars408_msgs::msg::FilterStateCfg *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _FilterStateCfg__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<radar_conti_ars408_msgs::msg::FilterStateCfg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FilterStateCfg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const radar_conti_ars408_msgs::msg::FilterStateCfg *>(
...
static size_t _FilterStateCfg__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_FilterStateCfg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FilterStateCfg__callbacks = {
  "radar_conti_ars408_msgs::msg",
  "FilterStateCfg",
  _FilterStateCfg__cdr_serialize,
  _FilterStateCfg__cdr_deserialize,
  _FilterStateCfg__get_serialized_size,
  _FilterStateCfg__max_serialized_size
};

static rosidl_message_type_support_t _FilterStateCfg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FilterStateCfg__callbacks,
...
{
  return &radar_conti_ars408_msgs::msg::typesupport_fastrtps_cpp::_FilterStateCfg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, radar_conti_ars408_msgs, msg, FilterStateCfg)() {
  return &radar_conti_ars408_msgs::msg::typesupport_fastrtps_cpp::_FilterStateCfg__handle;
}
