...
#include "radar_conti_ars408_msgs/msg/detail/object_quality__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.obj_distlong_rms,
    cdr);
  // Member: obj_distlat_rms
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.obj_distlat_rms,
    cdr);
  // Member: obj_vrellong_rms
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.obj_vrellong_rms,
    cdr);
  // Member: obj_vrellat_rms
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.obj_vrellat_rms,
    cdr);
  // Member: obj_arellong_rms
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.obj_arellong_rms,
    cdr);
  // Member: obj_arellat_rms
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.obj_arellat_rms,
    cdr);
  // Member: obj_orientation_rms
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.obj_orientation_rms,
    cdr);
  // Member: obj_probofexist
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.obj_probofexist,
    cdr);
  // Member: obj_measstate
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.obj_measstate,
    cdr);
  return true;
}
...
{
  auto typed_message =
    static_cast<const radar_conti_ars408_msgs::msg::ObjectQuality *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_conti_ars408_msgs::msg::ObjectQuality *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectQuality__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const radar_conti_ars408_msgs::msg::ObjectQuality *>(
...
static size_t _ObjectQuality__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObjectQuality(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ObjectQuality__callbacks = {
...
static rosidl_message_type_support_t _ObjectQuality__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectQuality__callbacks,
...
{
  return &radar_conti_ars408_msgs::msg::typesupport_fastrtps_cpp::_ObjectQuality__handle;
}
