...
#include "radar_conti_ars408_msgs/msg/detail/radar_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const radar_conti_ars408_msgs::msg::RadarState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_nvmwritestatus,
    cdr);
  // Member: radarstate_nvmreadstatus
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_nvmreadstatus,
    cdr);
  // Member: radarstate_maxdistancecfg
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_maxdistancecfg,
    cdr);
  // Member: radarstate_persistent_error
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_persistent_error,
    cdr);
  // Member: radarstate_interference
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_interference,
    cdr);
  // Member: radarstate_temperature_error
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_temperature_error,
    cdr);
  // Member: radarstate_temporary_error
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_temporary_error,
    cdr);
  // Member: radarstate_voltage_error
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_voltage_error,
    cdr);
  // Member: radarstate_radarpowercfg
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_radarpowercfg,
    cdr);
  // Member: radarstate_sortindex
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_sortindex,
    cdr);
  // Member: radarstate_sensorid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_sensorid,
    cdr);
  // Member: radarstate_motionrxstate
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_motionrxstate,
    cdr);
  // Member: radarstate_sendextinfocfg
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_sendextinfocfg,
    cdr);
  // Member: radarstate_sendqualitycfg
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_sendqualitycfg,
    cdr);
  // Member: radarstate_outputtypecfg
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_outputtypecfg,
    cdr);
  // Member: radarstate_ctrlrelaycfg
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_ctrlrelaycfg,
    cdr);
  // Member: radarstate_rcs_threshold
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarstate_rcs_threshold,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  radar_conti_ars408_msgs::msg::RadarState & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_radar_conti_ars408_msgs
max_serialized_size_RadarState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const radar_conti_ars408_msgs::msg::RadarState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_conti_ars408_msgs::msg::RadarState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RadarState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const radar_conti_ars408_msgs::msg::RadarState *>(
...
static size_t _RadarState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RadarState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RadarState__callbacks = {
...
static rosidl_message_type_support_t _RadarState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RadarState__callbacks,
...
{
  return &radar_conti_ars408_msgs::msg::typesupport_fastrtps_cpp::_RadarState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, radar_conti_ars408_msgs, msg, RadarState)() {
  return &radar_conti_ars408_msgs::msg::typesupport_fastrtps_cpp::_RadarState__handle;
}
