...
#include "radar_conti_ars408_msgs/msg/detail/radar_configuration__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const radar_conti_ars408_msgs::msg::RadarConfiguration & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_storeinnvm_valid,
    cdr);
  // Member: radarcfg_sortindex_valid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_sortindex_valid,
    cdr);
  // Member: radarcfg_sendextinfo_valid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_sendextinfo_valid,
    cdr);
  // Member: radarcfg_sendquality_valid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_sendquality_valid,
    cdr);
  // Member: radarcfg_outputtype_valid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_outputtype_valid,
    cdr);
  // Member: radarcfg_radarpower_valid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_radarpower_valid,
    cdr);
  // Member: radarcfg_sensorid_valid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_sensorid_valid,
    cdr);
  // Member: radarcfg_maxdistance_valid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_maxdistance_valid,
    cdr);
  // Member: radarcfg_maxdistance
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_maxdistance,
    cdr);
  // Member: radarcfg_radarpower
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_radarpower,
    cdr);
  // Member: radarcfg_outputtype
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_outputtype,
    cdr);
  // Member: radarcfg_sensorid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_sensorid,
    cdr);
  // Member: radarcfg_storeinnvm
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_storeinnvm,
    cdr);
  // Member: radarcfg_sortindex
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_sortindex,
    cdr);
  // Member: radarcfg_sendextinfo
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_sendextinfo,
    cdr);
  // Member: radarcfg_sendquality
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_sendquality,
    cdr);
  // Member: radarcfg_ctrlrelay
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_ctrlrelay,
    cdr);
  // Member: radarcfg_ctrlrelay_valid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_ctrlrelay_valid,
    cdr);
  // Member: radarcfg_rcs_threshold
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_rcs_threshold,
    cdr);
  // Member: radarcfg_rcs_threshold_valid
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.radarcfg_rcs_threshold_valid,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  radar_conti_ars408_msgs::msg::RadarConfiguration & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_radar_conti_ars408_msgs
max_serialized_size_RadarConfiguration(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const radar_conti_ars408_msgs::msg::RadarConfiguration *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_conti_ars408_msgs::msg::RadarConfiguration *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RadarConfiguration__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const radar_conti_ars408_msgs::msg::RadarConfiguration *>(
...
static size_t _RadarConfiguration__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_RadarConfiguration(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RadarConfiguration__callbacks = {
...
static rosidl_message_type_support_t _RadarConfiguration__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RadarConfiguration__callbacks,
...
{
  return &radar_conti_ars408_msgs::msg::typesupport_fastrtps_cpp::_RadarConfiguration__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, radar_conti_ars408_msgs, msg, RadarConfiguration)() {
  return &radar_conti_ars408_msgs::msg::typesupport_fastrtps_cpp::_RadarConfiguration__handle;
}
