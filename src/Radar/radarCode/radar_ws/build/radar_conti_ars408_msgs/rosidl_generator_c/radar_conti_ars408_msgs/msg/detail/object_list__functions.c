...
bool
radar_conti_ars408_msgs__msg__ObjectList__are_equal(const radar_conti_ars408_msgs__msg__ObjectList * lhs, const radar_conti_ars408_msgs__msg__ObjectList * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // objects
  if (!radar_conti_ars408_msgs__msg__Object__Sequence__are_equal(
...
bool
radar_conti_ars408_msgs__msg__ObjectList__copy(
  const radar_conti_ars408_msgs__msg__ObjectList * input,
  radar_conti_ars408_msgs__msg__ObjectList * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  if (!std_msgs__msg__Int32__copy(
      &(input->object_count), &(output->object_count)))
  {
    return false;
  }
  // objects
  if (!radar_conti_ars408_msgs__msg__Object__Sequence__copy(
...
radar_conti_ars408_msgs__msg__ObjectList__create()
{
  ...
  radar_conti_ars408_msgs__msg__ObjectList * msg = (radar_conti_ars408_msgs__msg__ObjectList *)allocator.allocate(sizeof(radar_conti_ars408_msgs__msg__ObjectList), allocator.state);
  if (!msg) {
    return NULL;
  }
...
radar_conti_ars408_msgs__msg__ObjectList__Sequence__init(radar_conti_ars408_msgs__msg__ObjectList__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (radar_conti_ars408_msgs__msg__ObjectList *)allocator.zero_allocate(size, sizeof(radar_conti_ars408_msgs__msg__ObjectList), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  radar_conti_ars408_msgs__msg__ObjectList__Sequence * array = (radar_conti_ars408_msgs__msg__ObjectList__Sequence *)allocator.allocate(sizeof(radar_conti_ars408_msgs__msg__ObjectList__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
radar_conti_ars408_msgs__msg__ObjectList__Sequence__are_equal(const radar_conti_ars408_msgs__msg__ObjectList__Sequence * lhs, const radar_conti_ars408_msgs__msg__ObjectList__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!radar_conti_ars408_msgs__msg__ObjectList__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
radar_conti_ars408_msgs__msg__ObjectList__Sequence__copy(
  const radar_conti_ars408_msgs__msg__ObjectList__Sequence * input,
  radar_conti_ars408_msgs__msg__ObjectList__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(radar_conti_ars408_msgs__msg__ObjectList);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    radar_conti_ars408_msgs__msg__ObjectList * data =
      (radar_conti_ars408_msgs__msg__ObjectList *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!radar_conti_ars408_msgs__msg__ObjectList__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          radar_conti_ars408_msgs__msg__ObjectList__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!radar_conti_ars408_msgs__msg__ObjectList__copy(
