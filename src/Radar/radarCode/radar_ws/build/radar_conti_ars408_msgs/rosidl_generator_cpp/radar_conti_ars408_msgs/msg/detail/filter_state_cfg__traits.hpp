...
inline std::string to_yaml(const FilterStateCfg & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const radar_conti_ars408_msgs::msg::FilterStateCfg & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const radar_conti_ars408_msgs::msg::FilterStateCfg & msg)
{
