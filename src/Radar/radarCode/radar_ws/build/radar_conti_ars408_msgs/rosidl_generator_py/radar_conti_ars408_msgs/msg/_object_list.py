    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'radar_conti_ars408_msgs.msg.ObjectList')
            logger.debug(
            ...
            from radar_conti_ars408_msgs.msg import Object
...
class ObjectList(metaclass=Metaclass_ObjectList):
    ...
    _fields_and_field_types = {
        ...
        'object_count': 'std_msgs/Int32',
        'objects': 'sequence<radar_conti_ars408_msgs/Object>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Int32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['radar_conti_ars408_msgs', 'msg'], 'Object')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Int32
        self.object_count = kwargs.get('object_count', Int32())
    ...
    def object_count(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'object_count' field must be a sub message of type 'Int32'"
